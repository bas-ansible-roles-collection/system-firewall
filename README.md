...
* `ansible_local.barc-system-firewall.general.role_applied` - to indicate that this role has been applied
* `ansible_local.barc-system-firewall.general.role_version` - to indicate the applied version of this role
