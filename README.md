...
Master: [![Build Status](https://semaphoreci.com/api/v1/bas-ansible-roles-collection/system-firewall/branches/master/badge.svg)](https://semaphoreci.com/bas-ansible-roles-collection/system-firewall)
Develop: [![Build Status](https://semaphoreci.com/api/v1/bas-ansible-roles-collection/system-firewall/branches/develop/badge.svg)](https://semaphoreci.com/bas-ansible-roles-collection/system-firewall)
...
* `ansible_local.barc_system_firewall.general.role_applied` - (boolean) records whether a role has been applied
* `ansible_local.barc_system_firewall.general.role_version` - (string) records the version of the role that was applied
...
#### *system_firewall_barc_role_name*

* **MUST NOT** be specified
* specifies the name of this role within the BAS Ansible Roles Collection (BARC) used for setting local facts
* see the *BARC roles manifest* section for more information
* example: `system_firewall`

#### *system_firewall_barc_role_version*
